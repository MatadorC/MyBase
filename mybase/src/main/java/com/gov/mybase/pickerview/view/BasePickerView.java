package com.gov.mybase.pickerview.view;
...
import com.gov.mybase.pickerview.listener.DialogDismissListener;
import com.gov.mybase.pickerview.configure.PickerOptions;
import com.gov.mybase.pickerview.listener.OnDismissListener;
import com.gov.mybase.pickerview.utils.PickerViewAnimateUtil;
...
public class BasePickerView {
    ...
    public void createDialog() {
        if (dialogView != null) {
            ...
            mDialog.setOnDismissListener(DialogDismissListener.wrap(onDialogDismissListener).recycleOnDetach(mDialog));
        }
    }
